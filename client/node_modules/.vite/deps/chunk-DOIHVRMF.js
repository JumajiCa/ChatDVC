...
function each(node, flags, get_collection, get_key, render_fn, fallback_fn = null) {
  ...
  function commit() {
    ...
    if (fallback2 !== null) {
      if (array.length === 0) {
        ...
        each_effect.first = fallback2.effect;
      } else {
  ...
  var each_effect = block(() => {
    ...
    for (var i = 0; i < length; i += 1) {
      ...
      var item = first_run ? null : state2.items.get(key2);
      if (item) {
...
//# sourceMappingURL=chunk-DOIHVRMF.js.map
